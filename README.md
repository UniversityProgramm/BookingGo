...
BookingGo — это REST API для управления бронированиями, построенный по принципам
чистой архитектуры. Проект поддерживает многоканальные уведомления (email, SMS, in-app),
двухфакторную аутентификацию (TOTP), кэширование через Redis и гарантирует доставку
